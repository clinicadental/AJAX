...
function estadoPeticionPag(){
    if(this.readyState==4&&this.status==200){
		...
		if(resultados.length==0){
			...
			texto="<table class='table'><tr><th>ID</th><th>IMPORTE</th><th>CLIENTE</th><th>FECHA</th><th>PAGADO</th></tr>";
			for(var i=0;i<resultados.length;i++){
				...
				texto+="<tr><td>"+objeto.id+"</td><td>"+objeto.importe+'€'+"</td><td>"+objeto.apellidos+", "+objeto.nombre+"</td><td>"+objeto.fechapago+"</td><td>"+pagado+"</td></tr>";
			}
		}
